...
def createDict():
    fin = open("PROJ2-DNSTS2.txt", "r")  # Open the file and insert all data into the dictionary
    flines = fin.readlines()
    for x in flines:
        splitStr = x.split()
        originalHostname = splitStr[0]
        dnst1[splitStr[0].lower()] = [splitStr[1], splitStr[2], originalHostname] # splitStr is the original hostname
